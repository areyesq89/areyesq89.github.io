...
\cventry{04/2020 - present}{Senior Expert I Data Science}{}{Novartis
  Institutes for BioMedical Research}{Basel, Switzerland}{
\begin{itemize}
\item Lead data science efforts of drug-development projects to
  understand mechanisms of action and to identify novel targets
  (transcriptomics, genetics, epigenetics, compound profiling, etc). 
\item Develop and implement software for the analysis of
  high-dimensional multi-omic datasets.
\item Mentor interns, masters students and postdocs; coordinate stakeholders
  across NIBR divisions to advance computational pipelines and
...
\cventry{11/2016 - 03/2020}{Postdoctoral Research Fellow}{}{Dana-Farber Cancer Institute and Harvard T.H. Chan School of Public Health}{Boston, USA}{
  \begin{itemize}
    ...
    \item Investigated how the epigenome and 3D structure of the
      genome is altered in colorectal cancer through the analysis and integration
      of multi-omic datasets. Designed an assay to identify the presence
...
\vspace{.1cm}
\begin{itemize}
\item C Gubser-Keller, ...,  \textbf{\underline{A Reyes}}, ..., R
  Sivasankaran. An orally available, brain penetrant, small molecule
  lowers huntingtin levels by enhancing pseudoexon
  inclusion. \textit{Nature Communications},
  2022. \href{https://doi.org/10.1038/s41467-022-28653-6}{doi:
    10.1038/s41467-022-28653-6} 
\item N Di Nanni, \textbf{\underline{A Reyes}}, ..., A de
  Weck. TRAWLING: a Transcriptome Reference Aware of spLIciNG
  events. \textit{bioRXiv}, 2021. \href{https://doi.org/10.1101/2021.12.03.471115}{doi:
    10.1101/2021.12.03.471115}
\item Y Qi, \textbf{\underline{A Reyes}}, ..., B Zhang. Data-driven
  polymer model for mechanistic exploration of diploid genome
  organization. \textit{Biophysical Journal}, 2020. \href{https://doi.org/10.1016/j.bpj.2020.09.009}{doi: 10.1016/j.bpj.2020.09.009}
\item K Korthauer$^{\ast}$, P Kimes$^{\ast}$, ... ,\textbf{\underline{A Reyes}}, ..., SC Hicks. A practical guide to
...
\cvitem{Languages}{Spanish (native), English (advanced), Italian (advanced), German (B1)}
\cvitem{Other}{Piano}
