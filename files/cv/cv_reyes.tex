...
\cventry{11/2016 - present}{Postdoctoral Research Fellow}{}{Dana-Farber Cancer Institute and Harvard T.H. Chan School of Public Health}{Boston, USA}{
  \begin{itemize}
    ...
    \item Project 2 (ongoing): I am developing an assay to identify the presence
      of circulating tumor DNA in the bloodstream. The assay is based on the sensitive
      detection of allelic frecuency imbalances caused by large
      genomic copy number alterations.
     \item Achievements: Co-authored three manuscripts, including one
